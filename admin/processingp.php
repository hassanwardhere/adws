...
$stmt = $pdo->prepare("UPDATE `order` SET status = 'Processing' WHERE id = ?");
...
header("Location: processorderp.php?alertType=success&alertMessage=Package Set to Processing successfully");
exit();
