...
$stmt = $pdo->query("SELECT `ordero`.*, users.firstname, users.lastname FROM `ordero` INNER JOIN users ON `ordero`.userid = users.id");
                ...
                <table id="default-datatable" class="table table-bordered">
                    ...
                    <tbody>
                        <?php foreach ($orders as $order) : ?>
                            <tr>
                                <td><?php echo $order['offername']; ?></td>
                                ...
                                <td>
                                    <a href="orderdetailso.php?id=<?php echo $order['id']; ?>" class="btn btn-info btn-sm">Details</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
