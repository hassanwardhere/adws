...
// Fetch order details
$stmt = $pdo->prepare("SELECT `ordero`.*, users.*, offers.* FROM `ordero` 
                        INNER JOIN users ON `ordero`.userid = users.id 
                        INNER JOIN offers ON `ordero`.offerid = offers.id 
                        WHERE `ordero`.id = ?");
...
$offerDetails = array(
    'offername' => $orderDetails['offername'],
    ...
    <div class="col-lg-12">
        <div class="card shadow">
            ...
            <div class="card-body">
                ...
                <hr>
                <br>
                <h5>offer Ordered Information</h5>
                <hr>
                <div class="row">
                ...
                <a href="processingo.php?id=<?php echo $orderId; ?>" class="btn btn-info">Set to Processing</a>
                <a href="processedo.php?id=<?php echo $orderId; ?>" class="btn btn-info">Set to Processed</a>
                <a href="approvedo.php?id=<?php echo $orderId; ?>" class="btn btn-success">Set to Approved</a>
                <a href="orderdenyo.php?id=<?php echo $orderId; ?>" class="btn btn-danger">Set to Denied</a>
                <a href="fraudo.php?id=<?php echo $orderId; ?>" class="btn btn-danger">Set to Fraud</a>
            </div>
        </div>
    </div>
</div>
